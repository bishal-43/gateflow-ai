...
Uses the same Redis QR lock pattern as entry_service to prevent parallel exit scans.
"""
...
async def process_exit(db: AsyncSession, qr_token: str, gate_id: str | None, _guard: User) -> ExitScanResponse:
